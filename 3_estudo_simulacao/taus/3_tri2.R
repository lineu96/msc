...
tri_n50 <- simula_tri_long(sample_size = sample_size,
...
tri_n100 <- simula_tri_long(sample_size = sample_size,
                       n_datasets = n_datasets,
                       n_treatment = n_treatment,
                       betas_normal = betas_normal,
                       betas_poisson = betas_poisson,
...
tri_n250 <- simula_tri_long(sample_size = sample_size,
                       n_datasets = n_datasets,
                       n_treatment = n_treatment,
                       betas_normal = betas_normal,
                       betas_poisson = betas_poisson,
...
tri_n500 <- simula_tri_long(sample_size = sample_size,
                       n_datasets = n_datasets,
                       n_treatment = n_treatment,
                       betas_normal = betas_normal,
                       betas_poisson = betas_poisson,
...
tri_n1000 <- simula_tri_long(sample_size = sample_size,
                        n_datasets = n_datasets,
                        n_treatment = n_treatment,
                        betas_normal = betas_normal,
                        betas_poisson = betas_poisson,
