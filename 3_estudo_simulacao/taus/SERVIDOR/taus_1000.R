...
load("datasets_poisson_n1000.RData"  )
...
load("datasets_bernoulli_n1000.RData")
...
bernoulli_tri_n1000 <- results

save(bernoulli_tri_n1000, file = "bernoulli_tri_n1000.RData")
