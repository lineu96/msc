...
# 
# ## Dataframe
# res_pred <- data.frame(index = rep(1:nrow(data_rbb2),2),
#                        resp = c(rep('count', nrow(data_rbb2)),
#                                 rep('prop', nrow(data_rbb2))),
#                        observado = c(data_rbb2$count,
#                                      data_rbb2$prop),
#                        preditos = preditos,
#                        pearson = pearson,
#                        raw = residuos
...
# ## Resíduo Pearson
# 
# mean1 = MASS::fitdistr(res_pred$pearson[1:nrow(data_rbb2)], 
#                        densfun = "normal")$estimate[1]
# 
# sd1 = MASS::fitdistr(res_pred$pearson[1:nrow(data_rbb2)], 
#                      densfun = "normal")$estimate[2]
# 
# mean2 = MASS::fitdistr(res_pred$pearson[(nrow(data_rbb2)+1):nrow(res_pred)], 
#                        densfun = "normal")$estimate[1]
# 
# sd2 = MASS::fitdistr(res_pred$pearson[(nrow(data_rbb2)+1):nrow(res_pred)], 
#                      densfun = "normal")$estimate[2]
# 
# mean1
# sd1
...
# ## Resíduo cru
# 
# mean3 = MASS::fitdistr(res_pred$raw[1:nrow(data_rbb2)], 
#                        densfun = "normal")$estimate[1]
# 
# sd3 = MASS::fitdistr(res_pred$raw[1:nrow(data_rbb2)], 
#                      densfun = "normal")$estimate[2]
# 
# mean4 = MASS::fitdistr(res_pred$raw[(nrow(data_rbb2)+1):nrow(res_pred)], 
#                        densfun = "normal")$estimate[1]
# 
# sd4 = MASS::fitdistr(res_pred$raw[(nrow(data_rbb2)+1):nrow(res_pred)], 
#                      densfun = "normal")$estimate[2]
# 
# mean3
# sd3
