...
Em tamanhos amostrais reduzidos em problemas com múltiplas respostas, observamos casos com taxas de rejeição em torno de 10\%, indicando que o teste seria liberal conforme aumenta a dimensionalidade, gerando taxas de erro tipo I superiores ao valor nominal de 5\%. Em tamanhos amostrais maiores, as taxas de erro do tipo I foram próximas do nível nominal.

De modo geral, os resultados das simulações mostraram que o teste Wald pode ser usado para avaliar hipóteses sobre parâmetros de regressão e dispersão de McGLMs, o que permite uma melhor interpretação do efeito das variáveis e estruturas de delineamento em contextos práticos.
